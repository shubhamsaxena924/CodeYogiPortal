...
const AuthPage: React.FC<Props> = (props) => {
  return (
    <>
      <div className="relative inset-0 flex w-full md:absolute">
        ...
        <div className="flex items-center justify-center flex-1 py-16 overflow-visible text-gray-700 lg:max-h-screen font-josefin">
          <Route path="/login">
            <LoginPage />
          </Route>
          <Route path="/signup">
        ...
        <div className="relative inset-0 w-0 duration-1000 lg:w-1/2 bg-secondary">
          <div className="absolute inset-0 flex items-center justify-center flex-1 w-1/2 h-full max-h-screen duration-1000 transform translate-x-full lg:w-full lg:relative lg:translate-x-0 bg-secondary">
            <svg
              width="65%"
              height="65%"
              viewBox="0 0 114 115"
            ...
            >
              ...
              <defs>
                ...
                >
                  ...
                  <feColorMatrix
                    type="matrix"
                    values="0 0 0 0 0.735 0 0 0 0 0.7774 0 0 0 0 1 0 0 0 0.49 0"
                  />
                  <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
